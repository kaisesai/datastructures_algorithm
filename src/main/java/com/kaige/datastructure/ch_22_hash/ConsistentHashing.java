package com.kaige.datastructure.ch_22_hash;
...
public class ConsistentHashing {
   ...
   * @return
   */
  private static MachineNode matcherMachineHashNode(String value) {
    // 计算哈希环值
   ...
   * @param ip 机器 IP 地址
   */
  private static void registerMachineHashNode(String ip) {
  ...
  static class MachineNode {
    ...
    public String toString() {
      return "{sequence=" + sequence + ", ip='" + ip + '\'' + ", virtualIp='" + virtualIp + '\''
        + ", hashRingCode=" + hashRingCode + ", isVirtual=" + isVirtual + '}';
    }
