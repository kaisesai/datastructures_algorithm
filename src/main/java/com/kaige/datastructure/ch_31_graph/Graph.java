package com.kaige.datastructure.ch_31_graph;
...
public class Graph {
   ...
   * @return
   */
  private List<Integer> threeDegreeRelationBfs(int s) {
    // 记录顶点是否被访问
   ...
   * @param s 起始顶点
   */
  private List<Integer> threeDegreeRelationDfs(int s) {
    // 寻找好友的好友的好友
    boolean[] visited = new boolean[v];
    visited[s] = true;
   ...
   * @param z 终止顶点
   */
  private void addEdge(int s, int z) {
    adj[s].add(z);
    adj[z].add(s);
  }
