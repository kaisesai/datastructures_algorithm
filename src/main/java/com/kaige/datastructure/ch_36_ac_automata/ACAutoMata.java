package com.kaige.datastructure.ch_36_ac_automata;
...
public class ACAutoMata {
  ...
  private static boolean match(char[] text, String[] patterns) {
  ...
  static class AcNode {
    ...
    AcNode getChild(char c) {
      return children.get(String.valueOf(c));
    }
    
    Collection<AcNode> getChildren() {
